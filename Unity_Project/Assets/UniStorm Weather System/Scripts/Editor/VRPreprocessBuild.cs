...
namespace UniStorm.Utility
{
    ...
    public class VRPreprocessBuild : IPreprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(UnityEditor.Build.Reporting.BuildReport report)
        {
            ...
            if (UnityEngine.XR.XRSettings.stereoRenderingMode == UnityEngine.XR.XRSettings.StereoRenderingMode.SinglePassInstanced) //(PlayerSettings.stereoRenderingPath == StereoRenderingPath.SinglePass)
                VRStateData.StereoRenderingMode = VRState.StereoRenderingModes.SinglePass;
            else if (UnityEngine.XR.XRSettings.stereoRenderingMode == UnityEngine.XR.XRSettings.StereoRenderingMode.MultiPass) //(PlayerSettings.stereoRenderingPath == StereoRenderingPath.MultiPass)
